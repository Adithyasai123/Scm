  ...
  const columns: Column<User>[] = [
    {
      ...
      render: (u) => (
        <div>
          ...
          <div className="text-[11px] font-mono text-slate-400">HRMS: {u.hrmsId || 'N/A'}</div>
        </div>
      ),
    },
    {
    ...
    },
    {
      key: 'mobileNumber',
      header: 'Mobile',
      render: (u) => <span className="font-mono text-xs text-slate-600">{u.mobileNumber || 'N/A'}</span>,
    },
    {
      key: 'roleName',
